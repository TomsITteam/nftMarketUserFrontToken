        ...
        <div class="col-12 col-xl-8">
          ...
          <b-skeleton-wrapper :loading="loading.nftData">
            ...
            <div class="asset__item">
              <span v-if="nftData.image_url || nftData.music_url" class="asset__img" v-viewer>
                <img :src="nftImageURL" :alt="nftName"/>
              </span>
              <span v-else class="asset__img">
                <video-player :options="videoOptions"/>
              </span>
              <div v-if="nftData.is_music" class="mt-2">
                <audio :src="nftData.music_url" controls class="w-100" />
              </div>
          ...
          <div class="asset__info mb-4 mb-sm-0">
            ...
            <b-skeleton-wrapper class="w-100" :loading="loading.nftData">
              ...
              <b-tabs class="w-100" nav-class="asset__tabs" content-class="mt-3">
                ...
                <b-tab v-if="!!nftTokenID && nftData.interface == 'erc1155'" class="nav-item" :title="$t('nft.owners')">
                  <div class="asset__actions" data-scrollbar="true" tabindex="-1" style="overflow: auto; outline: none;">
                    <div class="scroll-content">
                      <div class="asset__action mb-2" v-for="item in owners">
                ...
                <b-tab v-if="nftTokenID" class="nav-item" :title="$t('nft.transfers')">
                  <div class="asset__actions" data-scrollbar="true" tabindex="-1" style="overflow: auto; outline: none;">
                    <div class="scroll-content">
                      <div class="asset__action mb-2" v-for="item in transfers">
                ...
                <b-tab v-if="!!nftTokenID && nftData.interface == 'erc721'" class="nav-item" :title="$t('nft.bids')">
                  <div class="asset__actions">
                    <div class="asset__action mb-2"  v-for="item in bids">
                ...
                <b-tab :title="$t('nft.properties')" class="nav-item" v-if="nftData.attributes !== null">
                  <ul class="asset__authors--tab">
                    <li v-for="item in nftData.attributes">
            ...
            <div v-else class="w-100">
              ...
              <div v-if="nftOwner.address == this.$wallet.getWallet().getAccount() && nftData.interface != 'erc1155'" class="asset__btns">
                ...
                <b-button v-else-if="nftOwnerButtonType == 'cancelAuction2'" class="height-50 base-font-weight w-100 border-radius-10" variant="primary" @click="cancelAuction" v-bind:class="{ disabled: loading.button }">
                  <b-spinner type="grow" small v-if="loading.button == true"></b-spinner>
                  <span v-else>{{ $t('nft.stop_auction2') }}</span>
                </b-button>
              ...
              <div v-else-if="nftData.interface == 'erc721'" class="asset__btns">
                ...
                <b-button v-else-if="nftBuyerButtonType == 'nonOwnerAuctionEnd'" class="height-50 base-font-weight w-100 border-radius-10" variant="primary" disabled>
                  <span>{{ $t('nft.sale_end') }}</span>
                </b-button>
              </div>
            </div>
