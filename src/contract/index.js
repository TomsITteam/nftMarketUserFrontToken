...
let singleNFT = {
  ...
  async mint(net,nftId,price){
    let encodeFunctionData = {
      ...
      parameter_data : [nftId,Wallet.getWallet().getAccount(),"0x" + price.toString(16)]
    }
...
singleNFT.bid = async function(net,tokenId,price,tokenValue){
  let   encodeFunctionData = {
    method : 'bid',
    parameter_type : ['uint256','uint256'],
    parameter_data : [tokenId,tokenValue]
  }
